...
```json
{
  "api": {
    ...
    "documentation": "/docs/http-api-v1",
...
### `GET /docs/http-api-v1`

Packaged API reference served as Markdown from the installed runtime.

**Response `200`** — `Content-Type: text/markdown; charset=utf-8`

### `GET /docs/mcp-setup`

Packaged MCP setup guide served as Markdown from the installed runtime.
