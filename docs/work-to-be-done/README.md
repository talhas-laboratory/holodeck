...
This is the single home for the repository's improvement work and its durable source material.

- [High-level build milestones](BUILD_MILESTONES.md): the active, source-traceable roadmap for future implementation work.
- [M1 durable governance kernel design](../plans/2026-07-24-m1-durable-governance-kernel-design.md): the approved detailed design and decisions for the first active build milestone.
- [M1 governance kernel taskboard](taskboards/m1-governance-kernel/README.md): the scoped implementation board derived from the M1 design.
- [M3 context and mission compilation introduction](taskboards/m3-context-and-mission-compilation/INTRODUCTION.md): the planned compiler that turns a governed task origin and bounded factual context into an inspectable mission proposal.
