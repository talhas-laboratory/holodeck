...
- Changed artifacts: `README.md`, `pyproject.toml`, `tests/test_project_identity.py`, `docs/plans/2026-07-23-oss-adoption-gaps.md`, `docs/work-to-be-done/taskboards/local-coordination-hardening/DECISIONS.md`.
