...
Owner: `talha`  
Status: **in progress — M2-017 onboarding/refresh E2E next; M2-009 Buzz gated**
...
2. `M2-001`–`M2-008`, `M2-010`, `M2-012`–`M2-016`, and `M2-018` are done. Prefer
   **M2-017** onboarding/refresh E2E next. **M2-009** (Buzz adapter) remains
