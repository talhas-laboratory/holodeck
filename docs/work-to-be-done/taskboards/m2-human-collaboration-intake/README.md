...
Owner: `talha`
Status: **implementation in cumulative review; M2-021 ready; M2-009 Buzz gated**
...
3. `M2-001`–`M2-008`, `M2-010`, `M2-012`–`M2-020` are done. Prefer **M2-021**
   code-graph SQLite persistence next, then M2-022–M2-026. **M2-009**
