...
Owner: `talha`  
Status: **in progress — M2-014 source discovery next; M2-009 Buzz gated**
...
2. `M2-001`–`M2-008`, `M2-010`, `M2-012`, and `M2-013` are done. Prefer
   **M2-014** source discovery/trust classification next. **M2-009** (Buzz
   adapter) remains gated for live ingress. `M2-011` waits on `M2-017`.
