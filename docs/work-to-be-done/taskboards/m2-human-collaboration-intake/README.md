...
Owner: `talha`
Status: **implementation in cumulative review; M2-022 ready; M2-009 Buzz gated**
...
3. `M2-001`–`M2-008`, `M2-010`, `M2-012`–`M2-021` are done. Prefer **M2-022**
   Python reference extractor next, then M2-023–M2-026. **M2-009**
